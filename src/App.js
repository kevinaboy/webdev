      ...
      <div className="container-fluid p-0">
        <section className="resume-section" id="about">
          <div className="resume-section-content">
            ...
            <p className="lead mb-5">I am a Front-End Developer at Apple with over 12 years of work experience within Apple. My journey involves leading teams, managing projects, developing websites, solving technical issues for customers, and working with our engineers to make the best products possible.<br /><br />Driven to enhance my technical skills, I completed two certificate programs at UT Austin, the Project Management Certificate Program, and more recently, the Full Stack Web Developer Coding Boot Camp. I'm thrilled to continue my developer journey in a Frontend Mentorship Program at Apple.</p>
